...
from .views import add_funcionario, bloqueio, deletar_funcionario, index, lista_contas, modulos, login_view, cadastro, controle, deletar_usuario, dashboard, politica, add_item, add_venda, deletar_item, relatorio_mensal, add_cliente, deletar_cliente, deletar_venda, toggle_conta, sellix
